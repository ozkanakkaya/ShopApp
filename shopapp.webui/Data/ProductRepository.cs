    ...
    public static class ProductRepository
    {
        ...
        static ProductRepository()
        {
            _products = new List<Product>
            {
                ...
                new Product{ProductId=5,Name="Iphone 8",Price=3000,Description="128GB",IsApproved=true,ImageUrl="1.jpg",CategoryId=1},
                new Product{ProductId=6,Name = "Iphone 7", Price = 2500, Description = "64GB",IsApproved=false,ImageUrl="2.jpg",CategoryId=2 },
                new Product{ProductId=7,Name="Iphone 6",Price=2000,Description="32GB",IsApproved=true,ImageUrl="3.jpg",CategoryId=2},
                new Product{ProductId=8,Name = "Iphone 5", Price = 1500, Description = "16GB",ImageUrl="4.jpg",CategoryId=2 }
            };
        }
